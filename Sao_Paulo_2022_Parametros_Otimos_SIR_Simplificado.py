...
#Sao Paulo Casos busca Parâmetros Otimos 2022 SIR ARTIGO

# Dados Reais 
dado_real = np.loadtxt('sao_paulo_casos_mm7d_2022_sub.txt')
...
plt.xlabel('Número de casos Oficiais Confirmados em São Paulo 2022')
plt.ylabel('Número de casos Simulados Confirmados em São Paulo 2022')
...
with open('sao_paulo_casos_Simulados_2022.txt', 'w') as file:
