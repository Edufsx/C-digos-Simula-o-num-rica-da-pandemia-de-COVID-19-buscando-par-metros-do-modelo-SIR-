...
# Bauru Casos busca Parâmetros Otimos Bauru 2021 SIR ARTIGO

# Dados Reais 
dado_real = np.loadtxt('Bauru_casos_mm7d_2021_sub.txt')
...
plt.xlabel('Número de casos Oficiais Confirmados em Bauru 2021')
plt.ylabel('Número de casos Simulados Confirmados em Bauru 2021')
...
with open('Bauru_casos_Simulados_2021.txt', 'w') as file:
