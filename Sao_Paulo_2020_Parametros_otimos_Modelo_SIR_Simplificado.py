...
#Sao Paulo Casos busca Parâmetros Otimos 2020 SIR ARTIGO

# Dados Reais 
dado_real = np.loadtxt('sao_paulo_casos_mm7d_2020.txt')

#Taxas de Infecção e Recuperação
alpha=0.584 
beta=0.541
...
plt.xlabel('Número de casos Oficiais Confirmados em São Paulo 2020')
plt.ylabel('Número de casos Simulados Confirmados em São Paulo 2020')

# Dados Simulados e Dados Oficiais x Tempo
plt.figure()
plt.plot(t_vector, I_vector)
plt.plot(dado_real)
plt.xlabel('Dias - 2020')
plt.ylabel('Número de casos Confirmados em São Paulo')
"""

"""
# Salvar numero dados simulados
with open('sao_paulo_casos_Simulados_2020.txt', 'w') as file:
