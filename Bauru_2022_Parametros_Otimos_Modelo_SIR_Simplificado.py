...
# Bauru Casos busca Parâmetros Otimos Bauru 2022 SIR ARTIGO

# Dados Reais 
dado_real = np.loadtxt('Bauru_casos_mm7d_2022_sub.txt')
...
plt.xlabel('Número de casos Oficiais Confirmados em Bauru 2022')
plt.ylabel('Número de casos Simulados Confirmados em Bauru 2022')

# Dados Simulados e Dados Oficiais x Tempo
plt.figure()
plt.plot(t_vector, I_vector)
plt.plot(dado_real)
plt.xlabel('Dias - 2022')
plt.ylabel('Número de casos Confirmados em Bauru')
"""

"""
# Salvar os dados simulados em um arquivo texto
with open('Bauru_casos_Simulados_2022.txt', 'w') as file:
