...
# Dados Reais 
dado_real = np.loadtxt('Bauru_casos_mm7d_2020.txt')
...
plt.xlabel('Número de casos Oficiais Confirmados em Bauru 2020')
plt.ylabel('Número de casos Simulados Confirmados em Bauru 2020')
